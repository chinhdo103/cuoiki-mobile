        ...
        _speech.listen(
          onResult: (result) {
            setState(() {
              ...
              lang.text = _speechText; // Update the input field text with recognized speech
              updateTranslation(_speechText); // Update translation based on recognized speech
            });
          },
        );
      }
      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [Colors.yellow, Colors.white], // Define your colors here
          ),
        ),
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Container( // Wrap the existing container with another container for the border
                      decoration: BoxDecoration(
                        border: Border.all(
                    ...
                    children: [
                      InkWell(
                        onTap: () {
                          ...
                          if (out.isNotEmpty) {
                            Share.share(out); // Use the Share package to share the text
                          }
                        },
                        child: IconButton(
